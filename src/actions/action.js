...
//get all scorecard...
export const GET_ALL_SCORECARD = "GET_ALL_SCORECARD";
export const GET_ALL_SCORECARD_SUCCESS = "GET_ALL_SCORECARD_SUCCESS";
export const GET_ALL_SCORECARD_ERROR = "GET_ALL_SCORECARD_ERROR";

//add scorecard...
export const ADD_SCORECARD = "ADD_SCORECARD";
export const ADD_SCORECARD_SUCCESS = "ADD_SCORECARD_SUCCESS";
export const ADD_SCORECARD_ERROR = "ADD_SCORECARD_ERROR";

//delete scorecard...
export const DELETE_SCORECARD = "DELETE_SCORECARD";
export const DELETE_SCORECARD_SUCCESS = "DELETE_SCORECARD_SUCCESS";
export const DELETE_SCORECARD_ERROR = "DELETE_SCORECARD_ERROR";

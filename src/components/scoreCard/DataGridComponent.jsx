...
const DataGridComponent = ({recruiter, user, role}) => {
    ...
    return (
        <ThemeProvider theme={theme}>
            <Box sx={{
                ...
                <Stack spacing={2} sx={{width: '100%', p: 2, marginTop:'100px'}}>
                    {role === 'super-admin' && (
                        <Stack direction="row" spacing={2} alignItems="center">
                            <label htmlFor="recruiter-select" style={{fontSize:'20px'}} >Select Recruiter:</label>
                            <select
                                id="recruiter-select"
                                ...
                                style={{ padding: '8px', fontSize: '14px', zIndex: 1 }}
                            >
